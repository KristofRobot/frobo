...
class NavTest():
    def __init__(self):
        ...
        locations['hall'] = Pose(Point(1.136, 0.235, 0.000), Quaternion(0.000, 0.000, -0.196, 0.981))
        locations['living_room'] = Pose(Point(8.516, -2.807, 0.000), Quaternion(0.000, 0.000, -0.387, 0.922))
